...
public class BalloonsTypesDictionary
{
	...
	public static final int RED_BALLOON = 1;
	public static final int BLUE_BALLOON = 2;
	public static final int GREEN_BALLOON = 3;
	public static final int YELLOW_BALLOON = 4;
	public static final int PINK_BALLOON = 5;
	public static final int BLACK_BALLOON = 6;
	public static final int WHITE_BALLOON = 7;
	public static final int LEAD_BALLOON = 8;
	public static final int ZEBRA_BALLOON = 9;
	public static final int RAINBOW_BALLOON = 10;
	public static final int CERAMIC_BALLOON = 11;
	public static final int MOAB_BALLOON = 12;
	public static final int BFB_BALLOON = 13;
	public static final int ZOMG_BALLOON = 14;
